...
export const PERMISSIONS = {
  ...
  ROLE_ASSIGNMENT_EDIT: "ROLE_ASSIGNMENT_EDIT",
  ROLE_ASSIGNMENT_VIEW: "ROLE_ASSIGNMENT_VIEW",
...
> = {
  ...
  ROLE_ASSIGNMENT_CREATE: {
    ...
    description: "Create Sales Support role assignments",
  },
  ROLE_ASSIGNMENT_EDIT: {
    name: "Edit role assignments",
    description: "Edit Sales Support role assignments (versioned history)",
  },
  ROLE_ASSIGNMENT_VIEW: {
    name: "View role assignments",
    description: "View Sales Support role assignments in scope",
  },
...
export const ROLE_PERMISSION_MAP: Record<RoleCode, PermissionCode[]> = {
  ...
  TEAM_LEAD: [
    ...
    PERMISSIONS.ROLE_ASSIGNMENT_CREATE,
    PERMISSIONS.ROLE_ASSIGNMENT_EDIT,
